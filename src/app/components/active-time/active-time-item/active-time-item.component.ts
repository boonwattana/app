...
import { ActiveTimeItemModel } from '../active-time-model';
import { ActiveTimeService } from '../active-time.service';

@Component({
  selector: 'active-time-item',
  templateUrl: './active-time-item.component.html',
  styleUrls: ['./active-time-item.component.scss']
})
export class ActiveTimeItemComponent extends BaseItemComponent<ActiveTimeItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:ActiveTimeService, router: Router , route:ActivatedRoute){
