...
export class ActivityStudentService {
  servicePath = '/activity-student';
  constructor(private gateway: GatewayService) { }
  create(model:ActivityStudentItemModel):any{    
  ...
  update(id:number,model:ActivityStudentItemModel): any {
  ...
  initial():any{
    return of(new ActivityStudentItemModel())  ;
  }
}
