...
import { SarAdviseClassItemModel } from '../sar-advise-class-model';
import { SarAdviseClassService } from '../sar-advise-class.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-advise-class-item',
  templateUrl: './sar-advise-class-item.component.html',
  styleUrls: ['./sar-advise-class-item.component.scss']
})
export class SarAdviseClassItemComponent extends BaseItemComponent<SarAdviseClassItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private userDataService:UserDataService,private readonly service:SarAdviseClassService, router: Router , route:ActivatedRoute){
