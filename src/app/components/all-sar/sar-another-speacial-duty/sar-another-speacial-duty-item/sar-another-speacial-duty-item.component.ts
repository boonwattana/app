...
import { SarAnotherSpeacialDutyItemModel } from '../sar-another-speacial-duty-model';
import { SarAnotherSpeacialDutyService } from '../sar-another-speacial-duty.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-another-speacial-duty-item',
  templateUrl: './sar-another-speacial-duty-item.component.html',
  styleUrls: ['./sar-another-speacial-duty-item.component.scss']
})
export class SarAnotherSpeacialDutyItemComponent extends BaseItemComponent<SarAnotherSpeacialDutyItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private userDataService:UserDataService, private readonly service:SarAnotherSpeacialDutyService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-another-speacial-duty')
  }
}
