...
export class SarAnotherSpeacialDutyService {
  servicePath = '/sar-another-speacial-duty';
  constructor(private gateway: GatewayService) { }
  create(model:SarAnotherSpeacialDutyItemModel):any{    
  ...
  update(id:number,model:SarAnotherSpeacialDutyItemModel): any {
  ...
  initial():any{
    return of(new SarAnotherSpeacialDutyItemModel())  ;
  }
}
