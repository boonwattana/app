...
import { SarAwardItemModel } from '../sar-award-model';
import { SarAwardService } from '../sar-award.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-award-item',
  templateUrl: './sar-award-item.component.html',
  styleUrls: ['./sar-award-item.component.scss']
})
export class SarAwardItemComponent extends BaseItemComponent<SarAwardItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarAwardService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
