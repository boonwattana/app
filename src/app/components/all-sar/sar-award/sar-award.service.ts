...
export class SarAwardService {
  servicePath = '/sar-award';
  constructor(private gateway: GatewayService) { }
  create(model:SarAwardItemModel):any{    
  ...
  update(id:number,model:SarAwardItemModel): any {
  ...
  initial():any{
    return of(new SarAwardItemModel())  ;
  }
}
