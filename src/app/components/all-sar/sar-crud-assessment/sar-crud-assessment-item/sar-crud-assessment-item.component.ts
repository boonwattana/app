...
@Component({
  selector: 'sar-crud-assessment-item',
  templateUrl: './sar-crud-assessment-item.component.html',
  styleUrls: ['./sar-crud-assessment-item.component.scss']
})
export class SarCrudAssessmentItemComponent extends BaseItemComponent<SarCrudAssessmentItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarCrudAssessmentService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-crud-assessment')
  }
}
