...
import { SarIntegratedLearningItemModel } from '../sar-integrated-learning-model';
import { SarIntegratedLearningService } from '../sar-integrated-learning.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-integrated-learning-item',
  templateUrl: './sar-integrated-learning-item.component.html',
  styleUrls: ['./sar-integrated-learning-item.component.scss']
})
export class SarIntegratedLearningItemComponent extends BaseItemComponent<SarIntegratedLearningItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarIntegratedLearningService, router: Router,private userDataService:UserDataService , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-integrated-learning')
  }
}
