...
export class SarIntegratedLearningService {
  servicePath = '/sar-integrated-learning';
  constructor(private gateway: GatewayService) { }
  create(model:SarIntegratedLearningItemModel):any{    
  ...
  update(id:number,model:SarIntegratedLearningItemModel): any {
  ...
  initial():any{
    return of(new SarIntegratedLearningItemModel())  ;
  }
}
