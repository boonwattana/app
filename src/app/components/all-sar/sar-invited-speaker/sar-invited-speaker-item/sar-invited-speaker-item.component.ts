...
import { SarInvitedSpeakerItemModel } from '../sar-invited-speaker-model';
import { SarInvitedSpeakerService } from '../sar-invited-speaker.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-invited-speaker-item',
  templateUrl: './sar-invited-speaker-item.component.html',
  styleUrls: ['./sar-invited-speaker-item.component.scss']
})
export class SarInvitedSpeakerItemComponent extends BaseItemComponent<SarInvitedSpeakerItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarInvitedSpeakerService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-invited-speaker')
  }
}
