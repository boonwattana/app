...
export class SarInvitedSpeakerService {
  servicePath = '/sar-invited-speaker';
  constructor(private gateway: GatewayService) { }
  create(model:SarInvitedSpeakerItemModel):any{    
  ...
  update(id:number,model:SarInvitedSpeakerItemModel): any {
  ...
  initial():any{
    return of(new SarInvitedSpeakerItemModel())  ;
  }
}
