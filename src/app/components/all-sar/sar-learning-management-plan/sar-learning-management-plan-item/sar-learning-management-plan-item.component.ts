...
import { SarLearningManagementPlanItemModel } from '../sar-learning-management-plan-model';
import { SarLearningManagementPlanService } from '../sar-learning-management-plan.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-learning-management-plan-item',
  templateUrl: './sar-learning-management-plan-item.component.html',
  styleUrls: ['./sar-learning-management-plan-item.component.scss']
})
export class SarLearningManagementPlanItemComponent extends BaseItemComponent<SarLearningManagementPlanItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarLearningManagementPlanService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-learning-management-plan')
  }
}
