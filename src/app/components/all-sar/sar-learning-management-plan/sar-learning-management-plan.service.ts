...
export class SarLearningManagementPlanService {
  servicePath = '/sar-learning-management-plan';
  constructor(private gateway: GatewayService) { }
  create(model:SarLearningManagementPlanItemModel):any{    
  ...
  update(id:number,model:SarLearningManagementPlanItemModel): any {
  ...
  initial():any{
    return of(new SarLearningManagementPlanItemModel())  ;
  }
}
