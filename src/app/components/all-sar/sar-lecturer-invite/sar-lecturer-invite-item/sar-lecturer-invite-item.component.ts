...
import { SarLecturerInviteItemModel } from '../sar-lecturer-invite-model';
import { SarLecturerInviteService } from '../sar-lecturer-invite.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-lecturer-invite-item',
  templateUrl: './sar-lecturer-invite-item.component.html',
  styleUrls: ['./sar-lecturer-invite-item.component.scss']
})
export class SarLecturerInviteItemComponent extends BaseItemComponent<SarLecturerInviteItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarLecturerInviteService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-lecturer-invite')
  }
}
