...
export class SarMainMenuService {
  servicePath = '/sar-main-menu';
  constructor(private gateway: GatewayService) { }
  create(model:SarMainMenuItemModel):any{    
  ...
  update(id:number,model:SarMainMenuItemModel): any {
  ...
  initial():any{
    return of(new SarMainMenuItemModel())  ;
  }
}
