...
import { SarMediaProductionItemModel } from '../sar-media-production-model';
import { SarMediaProductionService } from '../sar-media-production.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-media-production-item',
  templateUrl: './sar-media-production-item.component.html',
  styleUrls: ['./sar-media-production-item.component.scss']
})
export class SarMediaProductionItemComponent extends BaseItemComponent<SarMediaProductionItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarMediaProductionService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-media-production')
  }
}
