...
export class SarMediaProductionService {
  servicePath = '/sar-media-production';
  constructor(private gateway: GatewayService) { }
  create(model:SarMediaProductionItemModel):any{    
  ...
  update(id:number,model:SarMediaProductionItemModel): any {
  ...
  initial():any{
    return of(new SarMediaProductionItemModel())  ;
  }
}
