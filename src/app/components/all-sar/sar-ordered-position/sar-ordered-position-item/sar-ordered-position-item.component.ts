...
@Component({
  selector: 'sar-ordered-position-item',
  templateUrl: './sar-ordered-position-item.component.html',
  styleUrls: ['./sar-ordered-position-item.component.scss']
})
export class SarOrderedPositionItemComponent extends BaseItemComponent<SarOrderedPositionItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarOrderedPositionService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-ordered-position')
  }
}
