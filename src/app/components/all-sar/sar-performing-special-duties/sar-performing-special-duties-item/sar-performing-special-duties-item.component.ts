...
import { SarPerformingSpecialDutiesItemModel } from '../sar-performing-special-duties-model';
import { SarPerformingSpecialDutiesService } from '../sar-performing-special-duties.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-performing-special-duties-item',
  templateUrl: './sar-performing-special-duties-item.component.html',
  styleUrls: ['./sar-performing-special-duties-item.component.scss']
})
export class SarPerformingSpecialDutiesItemComponent extends BaseItemComponent<SarPerformingSpecialDutiesItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarPerformingSpecialDutiesService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-performing-special-duties')
  }
}
