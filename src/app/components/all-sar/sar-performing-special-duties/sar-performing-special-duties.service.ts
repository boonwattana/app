...
export class SarPerformingSpecialDutiesService {
  servicePath = '/sar-performing-special-duties';
  constructor(private gateway: GatewayService) { }
  create(model:SarPerformingSpecialDutiesItemModel):any{    
  ...
  update(id:number,model:SarPerformingSpecialDutiesItemModel): any {
  ...
  initial():any{
    return of(new SarPerformingSpecialDutiesItemModel())  ;
  }
}
