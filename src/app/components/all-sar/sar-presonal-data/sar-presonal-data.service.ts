...
export class SarPresonalDataService {
  servicePath = '/sar-presonal-data';
  constructor(private gateway: GatewayService) { }
  create(model:SarPresonalDataItemModel):any{    
  ...
  update(id:number,model:SarPresonalDataItemModel): any {
  ...
  initial():any{
    return of(new SarPresonalDataItemModel())  ;
  }
  initialByTeacherId(id:string):any{
