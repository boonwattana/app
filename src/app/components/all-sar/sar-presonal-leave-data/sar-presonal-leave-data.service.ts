...
export class SarPresonalLeaveDataService {
  servicePath = '/sar-presonal-leave-data';
  constructor(private gateway: GatewayService) { }
  create(model:SarPresonalLeaveDataItemModel):any{    
  ...
  update(id:number,model:SarPresonalLeaveDataItemModel): any {
  ...
  initial():any{
    return of(new SarPresonalLeaveDataItemModel())  ;
  }
