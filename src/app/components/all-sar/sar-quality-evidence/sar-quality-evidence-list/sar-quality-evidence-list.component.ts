...
import { SarQualityEvidenceListModel } from '../sar-quality-evidence-model';
import { SarQualityEvidenceService } from '../sar-quality-evidence.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-quality-evidence-list',
  templateUrl: './sar-quality-evidence-list.component.html',
  styleUrls: ['./sar-quality-evidence-list.component.scss']
})
export class SarQualityEvidenceListComponent extends BaseListComponent<SarQualityEvidenceListModel> implements BaseListInterface {
  ...
  toItemPage(id:number,isView:boolean){
    this.toItem('sar-quality-evidence',id,isView)
  }
}
