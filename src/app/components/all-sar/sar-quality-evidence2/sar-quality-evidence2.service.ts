...
export class SarQualityEvidenceService {
  servicePath = '/sar-quality-evidence';
  constructor(private gateway: GatewayService) { }
  create(model:SarQualityEvidenceItemModel):any{    
  ...
  update(id:number,model:SarQualityEvidenceItemModel): any {
  ...
  initial():any{
    return of(new SarQualityEvidenceItemModel())  ;
  }
}
