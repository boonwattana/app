...
import { SarQualityEvidenceListModel } from '../sar-quality-evidence3-model';
import { SarQualityEvidenceService } from '../sar-quality-evidence3.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-quality-evidence3-list',
  templateUrl: './sar-quality-evidence3-list.component.html',
  styleUrls: ['./sar-quality-evidence3-list.component.scss']
})
export class SarQualityEvidenceListComponent extends BaseListComponent<SarQualityEvidenceListModel> implements BaseListInterface {
  ...
  toItemPage(id:number,isView:boolean){
    this.toItem('sar-quality-evidence3',id,isView)
  }
}
