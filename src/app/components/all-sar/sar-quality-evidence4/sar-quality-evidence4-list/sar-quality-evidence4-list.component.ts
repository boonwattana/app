...
import { SarQualityEvidenceListModel } from '../sar-quality-evidence4-model';
import { SarQualityEvidenceService } from '../sar-quality-evidence4.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-quality-evidence4-list',
  templateUrl: './sar-quality-evidence4-list.component.html',
  styleUrls: ['./sar-quality-evidence4-list.component.scss']
})
export class SarQualityEvidenceListComponent extends BaseListComponent<SarQualityEvidenceListModel> implements BaseListInterface {
  ...
  toItemPage(id:number,isView:boolean){
    this.toItem('sar-quality-evidence4',id,isView)
  }
}
