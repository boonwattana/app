...
import { SarQualityOfLearnersItemModel } from '../sar-quality-of-learners-model';
import { SarQualityOfLearnersService } from '../sar-quality-of-learners.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-quality-of-learners-item',
  templateUrl: './sar-quality-of-learners-item.component.html',
  styleUrls: ['./sar-quality-of-learners-item.component.scss']
})
export class SarQualityOfLearnersItemComponent extends BaseItemComponent<SarQualityOfLearnersItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarQualityOfLearnersService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-quality-of-learners')
  }
}
