...
import { SarQualityOfLearnersListModel } from '../sar-quality-of-learners-model';
import { SarQualityOfLearnersService } from '../sar-quality-of-learners.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-quality-of-learners-list',
  templateUrl: './sar-quality-of-learners-list.component.html',
  styleUrls: ['./sar-quality-of-learners-list.component.scss']
})
export class SarQualityOfLearnersListComponent extends BaseListComponent<SarQualityOfLearnersListModel> implements BaseListInterface {
  tableName:string ='sar_quality_of_learners'
  moduleName:string = 'MODULE.SAR_QUALITY_OF_LEARNERS'
  lastRemoveId:number = undefined;
  teacherOption:SelectItems[] = []
  be:number =new Date().getFullYear()+543;
  schoolyear= this.be.toString();
  constructor(private service: SarQualityOfLearnersService,
  ...
  setSerachCondtion(): void {
    const searchConditions:SearchCondition[] = [
      {
        tableName:'sar_quality_of_learners',
  ...
  toItemPage(id:number,isView:boolean){
    this.toItem('sar-quality-of-learners',id,isView)
  }
}
