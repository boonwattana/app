...
export class SarQualityOfLearnersService {
  servicePath = '/sar-quality-of-learners';
  constructor(private gateway: GatewayService) { }
  create(model:SarQualityOfLearnersItemModel):any{    
  ...
  update(id:number,model:SarQualityOfLearnersItemModel): any {
  ...
  initial():any{
    return of(new SarQualityOfLearnersItemModel())  ;
  }
}
