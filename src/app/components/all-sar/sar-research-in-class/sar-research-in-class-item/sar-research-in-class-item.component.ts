...
import { SarResearchInClassItemModel } from '../sar-research-in-class-model';
import { SarResearchInClassService } from '../sar-research-in-class.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-research-in-class-item',
  templateUrl: './sar-research-in-class-item.component.html',
  styleUrls: ['./sar-research-in-class-item.component.scss']
})
export class SarResearchInClassItemComponent extends BaseItemComponent<SarResearchInClassItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarResearchInClassService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-research-in-class')
  }
}
