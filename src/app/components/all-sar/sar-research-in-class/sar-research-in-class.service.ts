...
export class SarResearchInClassService {
  servicePath = '/sar-research-in-class';
  constructor(private gateway: GatewayService) { }
  create(model:SarResearchInClassItemModel):any{    
  ...
  update(id:number,model:SarResearchInClassItemModel): any {
  ...
  initial():any{
    return of(new SarResearchInClassItemModel())  ;
  }
}
