...
import { SarSelfAssessmentItemModel } from '../sar-self-assessment-model';
import { SarSelfAssessmentService } from '../sar-self-assessment.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-self-assessment-item',
  templateUrl: './sar-self-assessment-item.component.html',
  styleUrls: ['./sar-self-assessment-item.component.scss']
})
export class SarSelfAssessmentItemComponent extends BaseItemComponent<SarSelfAssessmentItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarSelfAssessmentService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-self-assessment')
  }
}
