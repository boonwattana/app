...
export class SarSelfDevelopmentService {
  servicePath = '/sar-self-development';
  constructor(private gateway: GatewayService) { }
  create(model:SarSelfDevelopmentItemModel):any{    
  ...
  update(id:number,model:SarSelfDevelopmentItemModel): any {
  ...
  initial():any{
    return of(new SarSelfDevelopmentItemModel())  ;
  }
}
