...
@Component({
  selector: 'sar-standard2-item',
  templateUrl: './sar-standard2-item.component.html',
  styleUrls: ['./sar-standard2-item.component.scss']
})
export class SarStandard2ItemComponent extends BaseItemComponent<SarStandard2ItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarStandard2Service,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
