...
import { SarStandard2ListModel } from '../sar-standard2-model';
import { SarStandard2Service } from '../sar-standard2.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-standard2-list',
  templateUrl: './sar-standard2-list.component.html',
  styleUrls: ['./sar-standard2-list.component.scss']
})
export class SarStandard2ListComponent extends BaseListComponent<SarStandard2ListModel> implements BaseListInterface {
  tableName:string ='sar_standard2'
  moduleName:string = 'MODULE.SAR_STANDARD2'
  lastRemoveId:number = undefined;
  teacherOption:SelectItems[] = []
  be:number =new Date().getFullYear()+543;
  schoolyear= this.be.toString();
  constructor(private service: SarStandard2Service,
  ...
  toItemPage(id:number,isView:boolean){
    this.toItem('sar-standard2',id,isView)
  }
}
