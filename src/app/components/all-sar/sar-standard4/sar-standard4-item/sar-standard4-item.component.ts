...
@Component({
  selector: 'sar-standard4-item',
  templateUrl: './sar-standard4-item.component.html',
  styleUrls: ['./sar-standard4-item.component.scss']
})
export class SarStandard4ItemComponent extends BaseItemComponent<SarStandard4ItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarStandard4Service,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
