...
import { SarStudentAssignItemModel } from '../sar-student-assign-model';
import { SarStudentAssignService } from '../sar-student-assign.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-student-assign-item',
  templateUrl: './sar-student-assign-item.component.html',
  styleUrls: ['./sar-student-assign-item.component.scss']
})
export class SarStudentAssignItemComponent extends BaseItemComponent<SarStudentAssignItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarStudentAssignService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-student-assign')
  }
}
