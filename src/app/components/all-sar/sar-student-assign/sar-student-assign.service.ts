...
export class SarStudentAssignService {
  servicePath = '/sar-student-assign';
  constructor(private gateway: GatewayService) { }
  create(model:SarStudentAssignItemModel):any{    
  ...
  update(id:number,model:SarStudentAssignItemModel): any {
  ...
  initial():any{
    return of(new SarStudentAssignItemModel())  ;
  }
}
