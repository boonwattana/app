...
export class SarStudentEstimateTeachingService {
  servicePath = '/sar-student-estimate-teaching';
  constructor(private gateway: GatewayService) { }
  create(model:SarStudentEstimateTeachingItemModel):any{    
  ...
  update(id:number,model:SarStudentEstimateTeachingItemModel): any {
  ...
  initial():any{
    return of(new SarStudentEstimateTeachingItemModel())  ;
  }
}
