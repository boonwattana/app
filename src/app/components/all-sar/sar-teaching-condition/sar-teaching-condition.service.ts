...
export class SarTeachingConditionService {
  servicePath = '/sar-teaching-condition';
  constructor(private gateway: GatewayService) { }
  create(model:SarTeachingConditionItemModel):any{    
  ...
  update(id:number,model:SarTeachingConditionItemModel): any {
  ...
  initial():any{
    return of(new SarTeachingConditionItemModel())  ;
  }
}
