...
import { SarTeachingFormatItemModel } from '../sar-teaching-format-model';
import { SarTeachingFormatService } from '../sar-teaching-format.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-teaching-format-item',
  templateUrl: './sar-teaching-format-item.component.html',
  styleUrls: ['./sar-teaching-format-item.component.scss']
})
export class SarTeachingFormatItemComponent extends BaseItemComponent<SarTeachingFormatItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarTeachingFormatService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-teaching-format')
  }
}
