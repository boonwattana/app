...
export class SarTeachingFormatService {
  servicePath = '/sar-teaching-format';
  constructor(private gateway: GatewayService) { }
  create(model:SarTeachingFormatItemModel):any{    
  ...
  update(id:number,model:SarTeachingFormatItemModel): any {
  ...
  initial():any{
    return of(new SarTeachingFormatItemModel())  ;
  }
