...
import { SarTeachingResultItemModel } from '../sar-teaching-result-model';
import { SarTeachingResultService } from '../sar-teaching-result.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-teaching-result-item',
  templateUrl: './sar-teaching-result-item.component.html',
  styleUrls: ['./sar-teaching-result-item.component.scss']
})
export class SarTeachingResultItemComponent extends BaseItemComponent<SarTeachingResultItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarTeachingResultService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
  ...
  backTolist(){    
    this.toList('sar-teaching-result')
  }
}
