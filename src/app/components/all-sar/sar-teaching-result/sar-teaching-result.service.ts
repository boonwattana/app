...
export class SarTeachingResultService {
  servicePath = '/sar-teaching-result';
  constructor(private gateway: GatewayService) { }
  create(model:SarTeachingResultItemModel):any{    
  ...
  update(id:number,model:SarTeachingResultItemModel): any {
  ...
  initial():any{
    return of(new SarTeachingResultItemModel())  ;
  }
}
