...
import { SarUploadImgItemModel } from '../sar-upload-img-model';
import { SarUploadImgService } from '../sar-upload-img.service';
import { UserDataService } from 'src/app/shared/services/user-data.service';
@Component({
  selector: 'sar-upload-img-item',
  templateUrl: './sar-upload-img-item.component.html',
  styleUrls: ['./sar-upload-img-item.component.scss']
})
export class SarUploadImgItemComponent extends BaseItemComponent<SarUploadImgItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:SarUploadImgService,private userDataService:UserDataService, router: Router , route:ActivatedRoute){
