...
export class SarUploadImgService {
  servicePath = '/sar-upload-img';
  constructor(private gateway: GatewayService) { }
  create(model:SarUploadImgItemModel):any{    
  ...
  update(id:number,model:SarUploadImgItemModel): any {
  ...
  initial():any{
    return of(new SarUploadImgItemModel())  ;
  }
}
