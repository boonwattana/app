...
export class SarService {
  ...
  update(id:number,model:SarItemModel): any {
  ...
  initial():any{
    return of(new SarItemModel())  ;
  }
  
  initialSarDetail(refIdValue:string):any{
    const url = `${this.servicePath}/initialSarDetail/${refIdValue}`;
    return  this.gateway.get(url);
  }
}
