...
import { ClassroomTypeItemModel } from '../classroom-type-model';
import { ClassroomTypeService } from '../classroom-type.service';

@Component({
  selector: 'classroom-type-item',
  templateUrl: './classroom-type-item.component.html',
  styleUrls: ['./classroom-type-item.component.scss']
})
export class ClassroomTypeItemComponent extends BaseItemComponent<ClassroomTypeItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:ClassroomTypeService, router: Router , route:ActivatedRoute){
