...
export class ClassroomTypeService {
  servicePath = '/classroom-type';
  constructor(private gateway: GatewayService) { }
  create(model:ClassroomTypeItemModel):any{    
  ...
  update(id:number,model:ClassroomTypeItemModel): any {
  ...
  initial():any{
    return of(new ClassroomTypeItemModel())  ;
  }
}
