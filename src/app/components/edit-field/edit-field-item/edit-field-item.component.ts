...
import { EditFieldItemModel } from '../edit-field-model';
...
export class EditFieldItemComponent extends BaseItemComponent<EditFieldItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:EditFieldService, router: Router , route:ActivatedRoute){
