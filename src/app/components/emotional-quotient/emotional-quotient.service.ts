...
export class EmotionalQuotientService {
  servicePath = '/emotional-quotient';
  constructor(private gateway: GatewayService) { }
  create(model:EmotionalQuotientItemModel):any{    
  ...
  update(id:number,model:EmotionalQuotientItemModel): any {
  ...
  initial():any{
    return of(new EmotionalQuotientItemModel())  ;
  }
  getCurrentTerm(): any {
