...
export class ParentStatusService {
  servicePath = '/parent-status';
  constructor(private gateway: GatewayService) { }
  create(model:ParentStatusItemModel):any{    
  ...
  update(id:number,model:ParentStatusItemModel): any {
  ...
  initial():any{
    return of(new ParentStatusItemModel())  ;
  }
}
