...
import { PracticleItemModel } from '../practicle-model';
import { PracticleService } from '../practicle.service';

@Component({
  selector: 'practicle-item',
  templateUrl: './practicle-item.component.html',
  styleUrls: ['./practicle-item.component.scss']
})
export class PracticleItemComponent extends BaseItemComponent<PracticleItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:PracticleService, router: Router , route:ActivatedRoute){
