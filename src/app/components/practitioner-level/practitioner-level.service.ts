...
export class PractitionerLevelService {
  servicePath = '/practitioner-level';
  constructor(private gateway: GatewayService) { }
  create(model:PractitionerLevelItemModel):any{    
  ...
  update(id:number,model:PractitionerLevelItemModel): any {
  ...
  initial():any{
    return of(new PractitionerLevelItemModel())  ;
  }
}
