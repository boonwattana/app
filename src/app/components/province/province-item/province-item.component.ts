...
@Component({
  selector: 'province-item',
  templateUrl: './province-item.component.html',
  styleUrls: ['./province-item.component.scss']
})
export class ProvinceItemComponent extends BaseItemComponent<ProvinceItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:ProvinceService, router: Router , route:ActivatedRoute){
