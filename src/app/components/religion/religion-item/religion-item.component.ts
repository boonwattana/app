...
import { ReligionItemModel } from '../religion-model';
import { ReligionService } from '../religion.service';

@Component({
  selector: 'religion-item',
  templateUrl: './religion-item.component.html',
  styleUrls: ['./religion-item.component.scss']
})
export class ReligionItemComponent extends BaseItemComponent<ReligionItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:ReligionService, router: Router , route:ActivatedRoute){
