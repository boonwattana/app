...
export class StudentSendToService {
  servicePath = '/student-consultant';
  constructor(private gateway: GatewayService) { }
  create(model:StudentConsultantItemModel):any{    
  ...
  update(id:number,model:StudentConsultantItemModel): any {
  ...
  initial():any{
    return of(new StudentConsultantItemModel())  ;
  }
