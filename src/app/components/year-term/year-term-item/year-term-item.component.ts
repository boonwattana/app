...
@Component({
  selector: 'year-term-item',
  templateUrl: './year-term-item.component.html',
  styleUrls: ['./year-term-item.component.scss']
})
export class YearTermItemComponent extends BaseItemComponent<YearTermItemModel>  implements BaseItemInterface {
  constructor(el:ElementRef,renderer:Renderer2,private readonly service:YearTermService, router: Router , route:ActivatedRoute){
