...
import { YearTermItemModel } from './year-term-model';
@Injectable({
  providedIn: 'root'
})
export class YearTermService {
  servicePath = '/year-term';
  constructor(private gateway: GatewayService) { }
  create(model:YearTermItemModel):any{    
  ...
  update(id:number,model:YearTermItemModel): any {
  ...
  initial():any{
    return of(new YearTermItemModel())  ;
  }
}
