...
@Component({
  selector: 'm-input-number-2filter',
  templateUrl: './m-input-number-2filter.component.html',
  styleUrls: ['./m-input-number-2filter.component.scss']
})
export class MInputNumber2FilterComponent extends BaseWidget implements OnInit {
  value1:number
  value2:number
  model1:boolean
  model2:boolean
