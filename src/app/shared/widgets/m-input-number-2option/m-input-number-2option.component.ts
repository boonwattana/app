...
@Component({
  selector: 'm-input-number-2option',
  templateUrl: './m-input-number-2option.component.html',
  styleUrls: ['./m-input-number-2option.component.scss']
})
export class MInputNumber2OptionComponent extends BaseWidget implements OnInit {
  value1:number
  value2:number
  model1:boolean
  model2:boolean
