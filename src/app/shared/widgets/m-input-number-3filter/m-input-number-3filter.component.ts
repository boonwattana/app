...
@Component({
  selector: 'm-input-number-3filter',
  templateUrl: './m-input-number-3filter.component.html',
  styleUrls: ['./m-input-number-3filter.component.scss']
})
export class MInputNumber3FilterComponent extends BaseWidget implements OnInit {
  value1:number
  value2:number
  value3:number
  model1:boolean
